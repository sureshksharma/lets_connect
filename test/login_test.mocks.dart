...
// in lets_connect/test/login_test.dart.
...
import 'package:lets_connect/data/repository/auth_impl.dart' as _i10;
import 'package:lets_connect/domain/listener.dart' as _i11;
import 'package:lets_connect/domain/model/user.dart' as _i12;
...
/// A class which mocks [AuthImpl].
///
/// See the documentation for Mockito's code generation for more information.
class MockAuthImpl extends _i1.Mock implements _i10.AuthImpl {
  MockAuthImpl() {
    _i1.throwOnMissingStub(this);
  }
  ...
  @override
  _i7.Future<_i12.UserData?> signInWithEmailAndPassword(
    String? email,
    String? password,
    _i11.DataListener? listener,
  ) =>
      (super.noSuchMethod(
        ...
        returnValue: _i7.Future<_i12.UserData?>.value(),
      ) as _i7.Future<_i12.UserData?>);
  @override
  _i7.Future<void> signOut(_i11.DataListener? listener) => (super.noSuchMethod(
        Invocation.method(
          #signOut,
          [listener],
        ),
